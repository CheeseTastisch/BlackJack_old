...
class Game {
    ...
    private fun printHands(
        ...
        terminal.printNice(buildList {
            ...
            add(rgb("#ffffaa")(dealerInformation ?: ""))
            ...
            add(rgb("#ffffaa")(handInformation ?: ""))

            add("")
            add(rgb("#ffffaa")(generalInformation ?: ""))
        })
    }
    ...
    private fun createHand(
        ...
        val winLoseContent = buildString {
            if (withWinLose) {
                ...
                when {
                    payout > 0 -> append(rgb("#aaffaa")(" Won $string"))
                    payout < 0 -> append(rgb("#ffaaaaaa")(" Lost $string"))
                    else -> append(rgb("#ffffaa")(" Push"))
                }
            }
        }
