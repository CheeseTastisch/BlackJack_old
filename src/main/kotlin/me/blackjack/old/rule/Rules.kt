...
object Rules {
    ...
    private val _startCapital = Rule.create("Start capital", StartCapital.THOUSAND)
    ...
    private val _split = Rule.create("Split", Split.TWO)
    private val _aceSplit = Rule.create("Ace Split", AceSplit.ONE_CARD)
    ...
    private val _surrender = Rule.create("Surrender", Surrender.ANY_NO_ACE)
